...
- garment_reference: N=3072, y=[0,63], x=[96,143]
- hair_reference: N=768, y=[96,158], x=[0,46]
...
|---|---:|---:|---:|---:|---:|
| background | 0.0788 | 0.6899 | 0.1838 | 0.0475 | 1.0000 |
| cloth | 0.0771 | 0.6935 | 0.1812 | 0.0482 | 1.0000 |
| face | 0.0842 | 0.6910 | 0.1763 | 0.0485 | 1.0000 |
| hair | 0.0811 | 0.6924 | 0.1779 | 0.0486 | 1.0000 |

Background total reference attention: `0.2313`.

## Decision

- conclusion: **LEAK-FOUND**
- reasons: `['background queries allocate too much mass to reference segments (0.231 > 0.150)']`

...
RUN="$ROOT/phase1/phase1_spatial_hair_region_resume_r16_4400_768x1024"
FINAL="$RUN/checkpoints/final"
CONFIG=configs/spatial_warmup_resume_hair.yaml
SUBSET="$ROOT/eval/cf_subset.json"
GEN="$ROOT/eval/b2p_spatial_hair_region_gen"
METRICS="$ROOT/eval/b2p_spatial_hair_region_metrics"
